var MedicalRecordList = function() {
    ...
    var initTable = function() {
        ...
        table.dataTable({
            ...
            "columnDefs": [{ // set default column settings
                    ...
                    "defaultContent": `<div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu pull-right" role="menu">
                                                        <li>
                                                            <a href="emrs_medical_record_detail.html">
                                                                <i class="icon-info"></i> 查看详情 </a>
                                                        </li>
                                                        <li class="divider"> </li>
                                                        <li>
                                                        <a href="javascript:;" style="color:#ED6B75" data-toggle="confirmation">
                                                                <i class="icon-trash" style="color:#ED6B75"></i> 删除记录 </a>
                                                        </li>
                                                    </ul>
                                                </div>`,
                }, {
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        ...
                        var status = "success"; //success:green,danger:red,warning:yellow,info:blue
                        if (data == "病重") {
                            status = "danger";
                        } else
                        if (data == "普通") {
                        ...
                        return "<span class='label label-sm label-" + status + "'> " + data + " </span>";
                    },
                    "targets": [7]
                }
            ],
            ...
            "ajax": {
                url: "../assets/pages/scripts/data.json"
            },
            "columns": [
                {},
                { "data": "bed_number" },
